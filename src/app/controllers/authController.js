...
router.post('/authenticate', async (req, res) => {
    ...
    // await -> utilizado para aguardar uma Promise
    if (!await bycript.compare(password, user.password)) return res.status(400).send({ error: 'Invalid password' });
